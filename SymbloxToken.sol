...
// File: contracts/SymbloxToken.sol
...
contract SymbloxToken is ERC20, ERC20Detailed, Ownable {
    ...
    function delegateBySig(
        ...
        require(signatory != address(0), "ERR_SIG");
        require(nonce == nonces[signatory]++, "ERR_SIG_NONCE");
        require(now <= expiry, "ERR_SIG_EXPIRED");
    ...
    function getPriorVotes(address account, uint256 blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ERR_PRIOR_VOTE");
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Symblox (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.number, "ERR_BLOCK_NUM");
