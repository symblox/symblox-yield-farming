...
export default function Balance(props) {
    ...
    return (
        <div className={classes.root}>
            ...
            <NumberFormat value={parseFloat(balance || 0).toLocaleString(undefined,{maximumFractionDigits: 10})} defaultValue={'-'} displayType={'text'} thousandSeparator={true} isNumericString={true} suffix={tokensName[name.toLowerCase()]} decimalScale={4} fixedDecimalScale={true} />
        </div>
    );
}
